...
var bespokeThemeNebula = createCommonjsModule(function (module, exports) {
/*!
...
var bespokeKeys = function(options) {
  return function(deck) {
...
var bespokeScale = function(options) {
  return function(deck) {
...
bespoke.from('#main', [bespokeThemeNebula(), bespokeKeys(), bespokeHash(), bespokeBackdrop(), bespokeScale()]);
